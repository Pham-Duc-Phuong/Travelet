            ...
            <nav className={cn("border-gray-200  shadow-lg dark:shadow-darkMode", { 'bg-white-rgba duration-700': !setScroll, 'bg-white dark:bg-gray-900 duration-700': setScroll })}>
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        ...
                        <button id="btn-menu" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-black rounded-lg md:hidden dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" onClick={() => { DropDown() }}>

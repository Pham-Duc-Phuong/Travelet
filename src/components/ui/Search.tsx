...
export const Search = () => {
    ...
    return (
        <div className='grid grid-col-1 sm:grid-cols-search w-full mx-3 sm:mx-5 items-center'>
            ...
            <button type='submit' className='mt-1 w-auto border-0 py-2 sm:mt-0 sm:mx-3 sm:w-fit sm:h-fit sm:px-3 rounded-md sm:rounded-[50%] bg-gradient-to-br from-cyan-300 to-blue-600 shadow-lg shadow-blue-500/50'><i className="fa-solid fa-magnifying-glass text-white"></i></button>
        </div>
    )
}
